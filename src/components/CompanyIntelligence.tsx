                    ...
                    <div className="h-20">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={[
                          ...
                          <XAxis type="number" tick={{ fontSize: 9, fill: "hsl(220,10%,55%)" }} tickFormatter={v => `${getCurrencySymbol()}${v}`} />
                          <YAxis dataKey="label" type="category" tick={{ fontSize: 9, fill: "hsl(220,10%,55%)" }} width={50} />
                          <Tooltip contentStyle={{ background: "hsl(220,12%,13%)", border: "1px solid hsl(220,12%,20%)", fontSize: 10 }} formatter={(v: number) => `${getCurrencySymbol()}${v}`} />
